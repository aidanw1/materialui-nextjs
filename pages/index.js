...
export default function LandingPage(props) {
  ...
  return (
    <Grid container direction="column" className={classes.mainContainer}>
        ...
        <Grid container justify="flex-end" alignItems="center" direction="row">
          <Grid sm item className={classes.heroTextContainer}>
            ...
            <Grid container justify="center" className={classes.buttonContainer}>
              ...
              <Grid item>
                <Button component={Link} href="/revolution" className={classes.learnButtonHero} variant="outlined" onClick={() => props.setValue(2)}>
      ...
      <Grid item>
        {/*-----Information Block-----*/}
        <Grid container style={{ height: "77em" }} alignItems="center" direction="row">
          <Grid
            item
            container
            style={{
          ...
          >
            <Grid item sm style={{ marginLeft: matchesXS ? 0 : matchesSM ? "2em" : "5em" }}>
              <Grid container style={{ marginBottom: matchesXS ? "10em" : 0 }} direction="column">
                ...
                <Grid item>
                  <Button component={Link} href="/about" variant="outlined" style={{ color: "white", borderColor: "white" }} className={classes.learnButton} onClick={() => props.setValue(3)}>
                    <span style={{ marginRight: 10 }}>Learn More</span>
            ...
            >
              <Grid container direction="column">
                ...
                <Grid item>
                  <Button component={Link} href="/contact" variant="outlined" style={{ color: "white", borderColor: "white" }} className={classes.learnButton} onClick={() => props.setValue(4)}>
                    <span style={{ marginRight: 10 }}>Learn More</span>
                    <ButtonArrow width={10} height={10} fill="white" />
                  </Button>
                </Grid>
