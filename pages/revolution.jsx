    ...
    <Grid container direction="column">
      ...
      <Grid style={{ backgroundColor: "#B3B3B3", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src="/assets/consultationIcon.svg" alt="handshake" width="100%" style={{ maxWith: 700 }} />
        </Grid>
      </Grid>
      ...
      <Grid style={{ backgroundColor: "#39B54A", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src="/assets/reviewIcon.svg" alt="magnifying glass" width="100%" style={{ maxWidth: matchesMD ? 300 : 400 }} />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#A67C52", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src="/assets/designIcon.svg" alt="paintbrush" style={{ maxWidth: 1000 }} width="100%" />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#39B54A", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        <Grid item container direction="column" alignItems={matchesMD ? "center" : undefined} lg>
      ...
      <Grid style={{ backgroundColor: "#FBB03B", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src="/assets/buildIcon.svg" alt="build" style={{ maxWidth: matchesMD ? 700 : 1000 }} width="100%" />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#C1272D", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src="/assets/launchIcon.svg" alt="launch" style={{ maxWidth: 200 }} width="100%" />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#8E45CE", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src="/assets/maintainIcon.svg" alt="maintain" style={{ maxWidth: 500 }} width="100%" />
        </Grid>
      </Grid>
      <Grid style={{ backgroundColor: "#29ABE2", height: "90em" }} item container direction={matchesMD ? "column" : "row"} className={classes.rowContainer}>
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src="/assets/iterateIcon.svg" alt="iterate" style={{ maxWidth: 1000 }} width="100%" />
        </Grid>
      </Grid>
    </Grid>
  );
